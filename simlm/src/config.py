...
class Arguments(TrainingArguments):
    ...
    recon_embs_path: Optional[str] = field(
        default=None,
        metadata={
            "help": "path to resconstructed embedding by trained SAE."
        },
    )
    inference_result: Optional[str] = field(
        default=None,
        metadata={
            "help": "path to decoding result from ."
        },
    )
    ...
    l2_normalize: bool = field(default=False, metadata={"help": "L2 normalize embeddings or not"})
    mean_pooling: bool = field(default=False, metadata={"help": "mean_pooling normalize embeddings or not"})
